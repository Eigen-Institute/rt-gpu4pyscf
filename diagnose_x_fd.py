...
def diagnose_fd_components():
    ...
    for j in range(mol.natm):
        if j == 0: continue
        q0, q1 = aoslices[j][2:]
        h_anal_ovlp -= float(contract('pq,pq->', W[p0:p1, q0:q1], s1aa[0,0,p0:p1, q0:q1])) * 2.0
